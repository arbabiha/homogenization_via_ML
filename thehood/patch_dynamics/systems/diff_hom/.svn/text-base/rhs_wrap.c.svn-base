...
#define SWIG_init    Rhs_Init
#define SWIG_name    "rhs"
#define SWIG_prefix  ""
...
#endif
static int
_wrap_rd_hom_rhs(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    double *arg1 = (double *) 0 ;
    double *arg2 = (double *) 0 ;
    double *arg3 = (double *) 0 ;
    double *arg4 = (double *) 0 ;
    
    if (SWIG_GetArgs(interp, objc, objv,"oooo:rd_hom_rhs double * double * double * double * ",(void *)0,(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_double,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[2], (void **) &arg2, SWIGTYPE_p_double,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    ...
    rd_hom_rhs(arg1,arg2,arg3,arg4);
...
static char *_wrap_ncomp_get(ClientData clientData, Tcl_Interp *interp, char *name1, char *name2, int flags) {
    Tcl_Obj *value = 0;
    
    value = Tcl_NewIntObj((long) ncomp);
    if (value) {
...
static char *_wrap_ncomp_set(ClientData clientData, Tcl_Interp *interp, char *name1, char *name2, int flags) {
    Tcl_Obj *value = 0;
    Tcl_Obj *name1o = 0;
...
static char *_wrap_delta_x_get(ClientData clientData, Tcl_Interp *interp, char *name1, char *name2, int flags) {
    Tcl_Obj *value = 0;
    
    value = Tcl_NewDoubleObj((double) delta_x);
    if (value) {
        Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
        Tcl_DecrRefCount(value);
    }
...
static char *_wrap_delta_x_set(ClientData clientData, Tcl_Interp *interp, char *name1, char *name2, int flags) {
    Tcl_Obj *value = 0;
    Tcl_Obj *name1o = 0;
...
static char *_wrap_PI_get(ClientData clientData, Tcl_Interp *interp, char *name1, char *name2, int flags) {
    Tcl_Obj *value = 0;
    
    value = Tcl_NewDoubleObj((double) PI);
    if (value) {
        Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
        Tcl_DecrRefCount(value);
    }
...
static char *_wrap_PI_set(ClientData clientData, Tcl_Interp *interp, char *name1, char *name2, int flags) {
    Tcl_Obj *value = 0;
    Tcl_Obj *name1o = 0;
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "rd_hom_rhs", (swig_wrapper_func) _wrap_rd_hom_rhs, NULL},
    {0, 0, 0}
};

static swig_var_info swig_variables[] = {
    { SWIG_prefix "ncomp", 0, (swig_variable_func) _wrap_ncomp_get,(swig_variable_func) _wrap_ncomp_set},
    { SWIG_prefix "delta_x", 0, (swig_variable_func) _wrap_delta_x_get,(swig_variable_func) _wrap_delta_x_set},
    { SWIG_prefix "PI", 0, (swig_variable_func) _wrap_PI_get,(swig_variable_func) _wrap_PI_set},
    {0,0,0,0}
};
...
SWIGEXPORT int Rhs_SafeInit(Tcl_Interp *interp) {
